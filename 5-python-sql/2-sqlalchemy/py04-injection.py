...
def lista_professores(bairro, zona):
    ...
    professores = connection.execute(f"SELECT * FROM professores p INNER JOIN bairros b ON b.id_bairro = p.id_bairro WHERE b.nm_bairro = '{bairro}' AND b.zona = '{zona}'").fetchall()
